$( function(){
    ...
    // --- Home - "All Items" section fill - Displays all in-stock items on home page
        ...
        for(let i in products){
            if (products[i].qty != 0) {
                $("#itemslist").append(
                    ...
                    // Adds items to trending items list - no more than 5
    ...
    // --- Product Search - Searches for product
